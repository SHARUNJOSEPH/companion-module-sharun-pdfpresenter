	...
	return {
		next_slide: {
			...
			style: {
				...
				bgcolor: combineRgb(16, 185, 129), // Emerald Green
			},
			steps: [
				{
					down: [
		...
		prev_slide: {
			...
			style: {
				...
				size: '18',
				color: combineRgb(255, 255, 255),
				bgcolor: combineRgb(37, 99, 235), // Royal Blue
			},
			steps: [
				{
					down: [
			...
			feedbacks: [
				{
					...
					options: {},
					style: {
						bgcolor: combineRgb(220, 38, 38), // Red when active
						color: combineRgb(255, 255, 255),
					},
				},
			],
...
module.exports.getPresetDefinitions = getPresetDefinitions
